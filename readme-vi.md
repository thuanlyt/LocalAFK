...
**Bản ổn định hiện tại:** [v1.1.0](https://github.com/thuanlyt/LocalAFK/releases/tag/v1.1.0) — tài liệu này đã mô tả sẵn kiến trúc 5 bot sắp phát hành dưới dạng `v1.2.0`, ngay khi các gate release trong repo pass.
...
Bản stable mới nhất là [v1.1.0](https://github.com/thuanlyt/LocalAFK/releases/tag/v1.1.0).
