...
**Current stable release:** [v1.1.0](https://github.com/thuanlyt/LocalAFK/releases/tag/v1.1.0) — this document already describes the upcoming five-bot architecture, published as `v1.2.0` once the release gates in this repo pass.
...
The latest stable version is [v1.1.0](https://github.com/thuanlyt/LocalAFK/releases/tag/v1.1.0).
